// Advanced ToDo List Tutorial from https://www.youtube.com/watch?v=W7FaYfuwu70
...
// create a namespace so you prevent overwriting your keys!
...
listsContainer.addEventListener("click", (e) => {
  // check whether li element was clicked:
...
deleteListBtn.addEventListener("click", (e) => {
  // filter all lists not currently selected
...
function renderLists() {
  lists.forEach((list) => {
    ...
    // set listId so you always know which item is selected:
